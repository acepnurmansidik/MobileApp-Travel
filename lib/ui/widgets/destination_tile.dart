...
class DestinationTile extends StatelessWidget {
  ...
  const DestinationTile({Key? key, required this.name, required this.city, required this.imgUrl, this.rating = 0.0}) : super(key: key);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  name,
                  style: blackStyle.copyWith(fontSize: 18, fontWeight: medium),
                ),
                Text(
                  city,
